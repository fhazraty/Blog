    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecialConfigurations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AbstractContent = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, "اسم سیستم مدیریت محتوا", "سیستم مدیریت محتوا من" },
                    { 5, "متن وسط بالا", "به سیستم مدیریت محتوا من خوش آمدید" },
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "BirthDate", "FirstName", "LastName", "NationalCode", "PasswordCreatedAt", "PasswordHash", "PasswordUpdatedAt", "Salt", "Username" },
                values: new object[] { 1, new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "ادمین", "ادمین", "1234567890", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "5fdf8fa7bf2a50747cb60d871a29cb9e0f6c3d60f34b94f2b4af3b41ee9a3fa2b3c68f30ec57a67e65d8b995b1366847cd5bb9246c788b4ae94db637660cc4d9", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "c6173eda-beb4-4d4a-a719-b80e38ba3f06", "admin" });
