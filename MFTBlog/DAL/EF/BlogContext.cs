...
namespace DAL.EF
{
    ...
    {
        /// <summary>
        /// Represents the users in the blog system.
        /// نمایانگر کاربران موجود در سیستم وبلاگ.
        /// </summary>
        public DbSet<User> Users { get; set; }

        /// <summary>
        /// Represents the roles in the blog system.
        /// نمایانگر نقش‌ها در سیستم وبلاگ.
        /// </summary>
        public DbSet<Role> Roles { get; set; }

        /// <summary>
        /// Represents the posts in the blog system.
        /// نمایانگر پست‌ها در سیستم وبلاگ.
        /// </summary>
        public DbSet<Post> Posts { get; set; }

        /// <summary>
        /// Represents the tags in the blog system.
        /// نمایانگر برچسب‌ها در سیستم وبلاگ.
        /// </summary>
        public DbSet<Tag> Tags { get; set; }

        /// <summary>
        /// Represents the categories in the blog system.
        /// نمایانگر دسته‌بندی‌ها در سیستم وبلاگ.
        /// </summary>
        public DbSet<Category> Categories { get; set; }

        /// <summary>
        /// Represents the uploaded files in the blog system.
        /// نمایانگر فایل‌های آپلود شده در سیستم وبلاگ.
        /// </summary>
        public DbSet<UploadedFile> UploadedFiles { get; set; }

        /// <summary>
        /// Represents the menus in the blog system.
        /// نمایانگر منوها در سیستم وبلاگ.
        /// </summary>
        public DbSet<Menu> Menus { get; set; }

        /// <summary>
        /// Represents the special configurations for the blog system.
        /// نمایانگر تنظیمات خاص سیستم وبلاگ.
        /// </summary>
        public DbSet<SpecialConfiguration> SpecialConfigurations { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="BlogContext"/> class without options.
        /// سازنده پیش‌فرض کلاس BlogContext.
        /// </summary>
        public BlogContext() { }

        /// <summary>
        /// Initializes a new instance of the <see cref="BlogContext"/> class with options.
        /// سازنده کلاس BlogContext با گزینه‌های تنظیمی.
        /// </summary>
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // مقداردهی اولیه برای تنظیمات خاص وبلاگ
